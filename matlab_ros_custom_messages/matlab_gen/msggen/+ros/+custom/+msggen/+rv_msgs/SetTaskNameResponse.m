classdef SetTaskNameResponse < ros.Message
    %SetTaskNameResponse MATLAB implementation of rv_msgs/SetTaskNameResponse
    ...
    properties (Constant)
        MessageType = 'rv_msgs/SetTaskNameResponse' % The ROS message type
    end
    ...
    methods
        function obj = SetTaskNameResponse(msg)
            %SetTaskNameResponse Construct the message object SetTaskNameResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'SetTaskNameResponse', 'Success');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.SetTaskNameResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.SetTaskNameResponse;
            obj.reload(strObj);
        end
    end
end
