classdef ActuateGripperActionGoal < ros.Message
    %ActuateGripperActionGoal MATLAB implementation of rv_msgs/ActuateGripperActionGoal
    ...
    properties (Constant)
        MessageType = 'rv_msgs/ActuateGripperActionGoal' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = 'f6ac12aefa03dfe4d1f449da482ecc31' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsActuateGripperGoalClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/ActuateGripperGoal') % Dispatch to MATLAB class for message type rv_msgs/ActuateGripperGoal
    ...
    methods
        function obj = ActuateGripperActionGoal(msg)
            %ActuateGripperActionGoal Construct the message object ActuateGripperActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'ActuateGripperActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'ActuateGripperActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.RvMsgsActuateGripperGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.RvMsgsActuateGripperGoalClass}, {'nonempty', 'scalar'}, 'ActuateGripperActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.RvMsgsActuateGripperGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.ActuateGripperActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.ActuateGripperActionGoal;
            obj.reload(strObj);
        end
    end
end
