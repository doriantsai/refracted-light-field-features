classdef SetPoseRequest < ros.Message
    %SetPoseRequest MATLAB implementation of rv_msgs/SetPoseRequest
    ...
    properties (Constant)
        MessageType = 'rv_msgs/SetPoseRequest' % The ROS message type
    end
    ...
    methods
        function obj = SetPoseRequest(msg)
            %SetPoseRequest Construct the message object SetPoseRequest
        ...
        function set.Pose(obj, pose)
            ...
            validateattributes(pose, {obj.GeometryMsgsPoseClass}, {'nonempty', 'scalar'}, 'SetPoseRequest', 'Pose');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.SetPoseRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.SetPoseRequest;
            obj.reload(strObj);
        end
    end
end
