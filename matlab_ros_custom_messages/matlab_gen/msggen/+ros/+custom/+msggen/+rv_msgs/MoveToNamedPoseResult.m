classdef MoveToNamedPoseResult < ros.Message
    %MoveToNamedPoseResult MATLAB implementation of rv_msgs/MoveToNamedPoseResult
    ...
    properties (Constant)
        MessageType = 'rv_msgs/MoveToNamedPoseResult' % The ROS message type
    end
    ...
    methods
        function obj = MoveToNamedPoseResult(msg)
            %MoveToNamedPoseResult Construct the message object MoveToNamedPoseResult
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {'numeric'}, {'nonempty', 'scalar'}, 'MoveToNamedPoseResult', 'Result');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.MoveToNamedPoseResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.MoveToNamedPoseResult;
            obj.reload(strObj);
        end
    end
end
