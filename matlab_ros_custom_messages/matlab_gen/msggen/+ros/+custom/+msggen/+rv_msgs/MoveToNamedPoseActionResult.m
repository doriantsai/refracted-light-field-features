classdef MoveToNamedPoseActionResult < ros.Message
    %MoveToNamedPoseActionResult MATLAB implementation of rv_msgs/MoveToNamedPoseActionResult
    ...
    properties (Constant)
        MessageType = 'rv_msgs/MoveToNamedPoseActionResult' % The ROS message type
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsMoveToNamedPoseResultClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/MoveToNamedPoseResult') % Dispatch to MATLAB class for message type rv_msgs/MoveToNamedPoseResult
    ...
    methods
        function obj = MoveToNamedPoseActionResult(msg)
            %MoveToNamedPoseActionResult Construct the message object MoveToNamedPoseActionResult
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'MoveToNamedPoseActionResult', 'Header');
        ...
        function set.Status(obj, status)
            ...
            validateattributes(status, {obj.ActionlibMsgsGoalStatusClass}, {'nonempty', 'scalar'}, 'MoveToNamedPoseActionResult', 'Status');
        ...
        function result = get.Result(obj)
            ...
            if isempty(obj.Cache.Result)
                obj.Cache.Result = feval(obj.RvMsgsMoveToNamedPoseResultClass, obj.JavaMessage.getResult);
            end
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {obj.RvMsgsMoveToNamedPoseResultClass}, {'nonempty', 'scalar'}, 'MoveToNamedPoseActionResult', 'Result');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Result = feval([obj.RvMsgsMoveToNamedPoseResultClass '.loadobj'], strObj.Result);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.MoveToNamedPoseActionResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.MoveToNamedPoseActionResult;
            obj.reload(strObj);
        end
    end
end
