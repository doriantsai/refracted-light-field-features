classdef MoveToPoseActionGoal < ros.Message
    %MoveToPoseActionGoal MATLAB implementation of rv_msgs/MoveToPoseActionGoal
    ...
    properties (Constant)
        MessageType = 'rv_msgs/MoveToPoseActionGoal' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '1f88db5a12b8660b649a5d5b85533409' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsMoveToPoseGoalClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/MoveToPoseGoal') % Dispatch to MATLAB class for message type rv_msgs/MoveToPoseGoal
    ...
    methods
        function obj = MoveToPoseActionGoal(msg)
            %MoveToPoseActionGoal Construct the message object MoveToPoseActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'MoveToPoseActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'MoveToPoseActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.RvMsgsMoveToPoseGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.RvMsgsMoveToPoseGoalClass}, {'nonempty', 'scalar'}, 'MoveToPoseActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.RvMsgsMoveToPoseGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.MoveToPoseActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.MoveToPoseActionGoal;
            obj.reload(strObj);
        end
    end
end
