classdef SayStringActionResult < ros.Message
    %SayStringActionResult MATLAB implementation of rv_msgs/SayStringActionResult
    ...
    properties (Constant)
        MessageType = 'rv_msgs/SayStringActionResult' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '465a4203e3691719a7a957b5f9b584ec' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsSayStringResultClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/SayStringResult') % Dispatch to MATLAB class for message type rv_msgs/SayStringResult
    ...
    methods
        function obj = SayStringActionResult(msg)
            %SayStringActionResult Construct the message object SayStringActionResult
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'SayStringActionResult', 'Header');
        ...
        function set.Status(obj, status)
            ...
            validateattributes(status, {obj.ActionlibMsgsGoalStatusClass}, {'nonempty', 'scalar'}, 'SayStringActionResult', 'Status');
        ...
        function result = get.Result(obj)
            ...
            if isempty(obj.Cache.Result)
                obj.Cache.Result = feval(obj.RvMsgsSayStringResultClass, obj.JavaMessage.getResult);
            end
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {obj.RvMsgsSayStringResultClass}, {'nonempty', 'scalar'}, 'SayStringActionResult', 'Result');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Result = feval([obj.RvMsgsSayStringResultClass '.loadobj'], strObj.Result);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.SayStringActionResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.SayStringActionResult;
            obj.reload(strObj);
        end
    end
end
