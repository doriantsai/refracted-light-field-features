classdef SayStringActionGoal < ros.Message
    %SayStringActionGoal MATLAB implementation of rv_msgs/SayStringActionGoal
    ...
    properties (Constant)
        MessageType = 'rv_msgs/SayStringActionGoal' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '91b11ffdca8f7ce1f8993398debeebd5' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsSayStringGoalClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/SayStringGoal') % Dispatch to MATLAB class for message type rv_msgs/SayStringGoal
    ...
    methods
        function obj = SayStringActionGoal(msg)
            %SayStringActionGoal Construct the message object SayStringActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'SayStringActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'SayStringActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.RvMsgsSayStringGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.RvMsgsSayStringGoalClass}, {'nonempty', 'scalar'}, 'SayStringActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.RvMsgsSayStringGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.SayStringActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.SayStringActionGoal;
            obj.reload(strObj);
        end
    end
end
