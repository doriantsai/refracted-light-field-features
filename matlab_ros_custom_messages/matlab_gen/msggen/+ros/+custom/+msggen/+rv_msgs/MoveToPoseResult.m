classdef MoveToPoseResult < ros.Message
    %MoveToPoseResult MATLAB implementation of rv_msgs/MoveToPoseResult
    ...
    properties (Constant)
        MessageType = 'rv_msgs/MoveToPoseResult' % The ROS message type
    end
    ...
    methods
        function obj = MoveToPoseResult(msg)
            %MoveToPoseResult Construct the message object MoveToPoseResult
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {'numeric'}, {'nonempty', 'scalar'}, 'MoveToPoseResult', 'Result');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.MoveToPoseResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.MoveToPoseResult;
            obj.reload(strObj);
        end
    end
end
