classdef MoveToPoseActionResult < ros.Message
    %MoveToPoseActionResult MATLAB implementation of rv_msgs/MoveToPoseActionResult
    ...
    properties (Constant)
        MessageType = 'rv_msgs/MoveToPoseActionResult' % The ROS message type
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsMoveToPoseResultClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/MoveToPoseResult') % Dispatch to MATLAB class for message type rv_msgs/MoveToPoseResult
    ...
    methods
        function obj = MoveToPoseActionResult(msg)
            %MoveToPoseActionResult Construct the message object MoveToPoseActionResult
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'MoveToPoseActionResult', 'Header');
        ...
        function set.Status(obj, status)
            ...
            validateattributes(status, {obj.ActionlibMsgsGoalStatusClass}, {'nonempty', 'scalar'}, 'MoveToPoseActionResult', 'Status');
        ...
        function result = get.Result(obj)
            ...
            if isempty(obj.Cache.Result)
                obj.Cache.Result = feval(obj.RvMsgsMoveToPoseResultClass, obj.JavaMessage.getResult);
            end
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {obj.RvMsgsMoveToPoseResultClass}, {'nonempty', 'scalar'}, 'MoveToPoseActionResult', 'Result');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Result = feval([obj.RvMsgsMoveToPoseResultClass '.loadobj'], strObj.Result);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.MoveToPoseActionResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.MoveToPoseActionResult;
            obj.reload(strObj);
        end
    end
end
