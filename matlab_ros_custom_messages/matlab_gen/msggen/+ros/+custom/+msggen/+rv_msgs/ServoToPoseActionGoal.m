classdef ServoToPoseActionGoal < ros.Message
    %ServoToPoseActionGoal MATLAB implementation of rv_msgs/ServoToPoseActionGoal
    ...
    properties (Constant)
        MessageType = 'rv_msgs/ServoToPoseActionGoal' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = 'cd2ce1ad33ebf4241cf64b28b4ca62bb' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsServoToPoseGoalClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/ServoToPoseGoal') % Dispatch to MATLAB class for message type rv_msgs/ServoToPoseGoal
    ...
    methods
        function obj = ServoToPoseActionGoal(msg)
            %ServoToPoseActionGoal Construct the message object ServoToPoseActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'ServoToPoseActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'ServoToPoseActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.RvMsgsServoToPoseGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.RvMsgsServoToPoseGoalClass}, {'nonempty', 'scalar'}, 'ServoToPoseActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.RvMsgsServoToPoseGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.ServoToPoseActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.ServoToPoseActionGoal;
            obj.reload(strObj);
        end
    end
end
