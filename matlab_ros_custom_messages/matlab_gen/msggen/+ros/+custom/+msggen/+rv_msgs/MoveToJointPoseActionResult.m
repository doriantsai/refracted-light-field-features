classdef MoveToJointPoseActionResult < ros.Message
    %MoveToJointPoseActionResult MATLAB implementation of rv_msgs/MoveToJointPoseActionResult
    ...
    properties (Constant)
        MessageType = 'rv_msgs/MoveToJointPoseActionResult' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '21d2e3bc785d2fbc4cfcd995646e4404' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsMoveToJointPoseResultClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/MoveToJointPoseResult') % Dispatch to MATLAB class for message type rv_msgs/MoveToJointPoseResult
    ...
    methods
        function obj = MoveToJointPoseActionResult(msg)
            %MoveToJointPoseActionResult Construct the message object MoveToJointPoseActionResult
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'MoveToJointPoseActionResult', 'Header');
        ...
        function set.Status(obj, status)
            ...
            validateattributes(status, {obj.ActionlibMsgsGoalStatusClass}, {'nonempty', 'scalar'}, 'MoveToJointPoseActionResult', 'Status');
        ...
        function result = get.Result(obj)
            ...
            if isempty(obj.Cache.Result)
                obj.Cache.Result = feval(obj.RvMsgsMoveToJointPoseResultClass, obj.JavaMessage.getResult);
            end
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {obj.RvMsgsMoveToJointPoseResultClass}, {'nonempty', 'scalar'}, 'MoveToJointPoseActionResult', 'Result');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Result = feval([obj.RvMsgsMoveToJointPoseResultClass '.loadobj'], strObj.Result);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.MoveToJointPoseActionResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.MoveToJointPoseActionResult;
            obj.reload(strObj);
        end
    end
end
