classdef MoveToJointPoseResult < ros.Message
    %MoveToJointPoseResult MATLAB implementation of rv_msgs/MoveToJointPoseResult
    ...
    properties (Constant)
        MessageType = 'rv_msgs/MoveToJointPoseResult' % The ROS message type
    end
    ...
    methods
        function obj = MoveToJointPoseResult(msg)
            %MoveToJointPoseResult Construct the message object MoveToJointPoseResult
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {'numeric'}, {'nonempty', 'scalar'}, 'MoveToJointPoseResult', 'Result');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.MoveToJointPoseResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.MoveToJointPoseResult;
            obj.reload(strObj);
        end
    end
end
