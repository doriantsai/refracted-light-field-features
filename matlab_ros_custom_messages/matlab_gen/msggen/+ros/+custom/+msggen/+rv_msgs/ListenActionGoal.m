classdef ListenActionGoal < ros.Message
    %ListenActionGoal MATLAB implementation of rv_msgs/ListenActionGoal
    ...
    properties (Constant)
        MessageType = 'rv_msgs/ListenActionGoal' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '8515f188b03103c9604853ed3c60325f' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsListenGoalClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/ListenGoal') % Dispatch to MATLAB class for message type rv_msgs/ListenGoal
    ...
    methods
        function obj = ListenActionGoal(msg)
            %ListenActionGoal Construct the message object ListenActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'ListenActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'ListenActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.RvMsgsListenGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.RvMsgsListenGoalClass}, {'nonempty', 'scalar'}, 'ListenActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.RvMsgsListenGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.ListenActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.ListenActionGoal;
            obj.reload(strObj);
        end
    end
end
