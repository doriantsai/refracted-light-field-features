classdef AskQuestionActionGoal < ros.Message
    %AskQuestionActionGoal MATLAB implementation of rv_msgs/AskQuestionActionGoal
    ...
    properties (Constant)
        MessageType = 'rv_msgs/AskQuestionActionGoal' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = 'de8c6b9dbea5d1642a5e98684a94e4f2' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsAskQuestionGoalClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/AskQuestionGoal') % Dispatch to MATLAB class for message type rv_msgs/AskQuestionGoal
    ...
    methods
        function obj = AskQuestionActionGoal(msg)
            %AskQuestionActionGoal Construct the message object AskQuestionActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'AskQuestionActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'AskQuestionActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.RvMsgsAskQuestionGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.RvMsgsAskQuestionGoalClass}, {'nonempty', 'scalar'}, 'AskQuestionActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.RvMsgsAskQuestionGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.AskQuestionActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.AskQuestionActionGoal;
            obj.reload(strObj);
        end
    end
end
