classdef MoveToJointPoseActionGoal < ros.Message
    %MoveToJointPoseActionGoal MATLAB implementation of rv_msgs/MoveToJointPoseActionGoal
    ...
    properties (Constant)
        MessageType = 'rv_msgs/MoveToJointPoseActionGoal' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '69e4313b6f24615a34220fec4567b2a0' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsMoveToJointPoseGoalClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/MoveToJointPoseGoal') % Dispatch to MATLAB class for message type rv_msgs/MoveToJointPoseGoal
    ...
    methods
        function obj = MoveToJointPoseActionGoal(msg)
            %MoveToJointPoseActionGoal Construct the message object MoveToJointPoseActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'MoveToJointPoseActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'MoveToJointPoseActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.RvMsgsMoveToJointPoseGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.RvMsgsMoveToJointPoseGoalClass}, {'nonempty', 'scalar'}, 'MoveToJointPoseActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.RvMsgsMoveToJointPoseGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.MoveToJointPoseActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.MoveToJointPoseActionGoal;
            obj.reload(strObj);
        end
    end
end
