classdef SetNamedPoseResponse < ros.Message
    %SetNamedPoseResponse MATLAB implementation of rv_msgs/SetNamedPoseResponse
    ...
    properties (Constant)
        MessageType = 'rv_msgs/SetNamedPoseResponse' % The ROS message type
    end
    ...
    methods
        function obj = SetNamedPoseResponse(msg)
            %SetNamedPoseResponse Construct the message object SetNamedPoseResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'SetNamedPoseResponse', 'Success');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.SetNamedPoseResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.SetNamedPoseResponse;
            obj.reload(strObj);
        end
    end
end
