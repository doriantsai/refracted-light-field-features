classdef GetDoorStatusResponse < ros.Message
    %GetDoorStatusResponse MATLAB implementation of rv_msgs/GetDoorStatusResponse
    ...
    properties (Constant)
        MessageType = 'rv_msgs/GetDoorStatusResponse' % The ROS message type
    end
    ...
    methods
        function obj = GetDoorStatusResponse(msg)
            %GetDoorStatusResponse Construct the message object GetDoorStatusResponse
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {'numeric'}, {'nonempty', 'scalar'}, 'GetDoorStatusResponse', 'Result');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.GetDoorStatusResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.GetDoorStatusResponse;
            obj.reload(strObj);
        end
    end
end
