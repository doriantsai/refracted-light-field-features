classdef ServoToPoseActionResult < ros.Message
    %ServoToPoseActionResult MATLAB implementation of rv_msgs/ServoToPoseActionResult
    ...
    properties (Constant)
        MessageType = 'rv_msgs/ServoToPoseActionResult' % The ROS message type
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsServoToPoseResultClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/ServoToPoseResult') % Dispatch to MATLAB class for message type rv_msgs/ServoToPoseResult
    ...
    methods
        function obj = ServoToPoseActionResult(msg)
            %ServoToPoseActionResult Construct the message object ServoToPoseActionResult
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'ServoToPoseActionResult', 'Header');
        ...
        function set.Status(obj, status)
            ...
            validateattributes(status, {obj.ActionlibMsgsGoalStatusClass}, {'nonempty', 'scalar'}, 'ServoToPoseActionResult', 'Status');
        ...
        function result = get.Result(obj)
            ...
            if isempty(obj.Cache.Result)
                obj.Cache.Result = feval(obj.RvMsgsServoToPoseResultClass, obj.JavaMessage.getResult);
            end
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {obj.RvMsgsServoToPoseResultClass}, {'nonempty', 'scalar'}, 'ServoToPoseActionResult', 'Result');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Result = feval([obj.RvMsgsServoToPoseResultClass '.loadobj'], strObj.Result);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.ServoToPoseActionResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.ServoToPoseActionResult;
            obj.reload(strObj);
        end
    end
end
