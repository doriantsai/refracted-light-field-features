classdef SetPoseResponse < ros.Message
    %SetPoseResponse MATLAB implementation of rv_msgs/SetPoseResponse
    ...
    properties (Constant)
        MessageType = 'rv_msgs/SetPoseResponse' % The ROS message type
    end
    ...
    methods
        function obj = SetPoseResponse(msg)
            %SetPoseResponse Construct the message object SetPoseResponse
        ...
        function set.Success(obj, success)
            ...
            validateattributes(success, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'SetPoseResponse', 'Success');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.SetPoseResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.SetPoseResponse;
            obj.reload(strObj);
        end
    end
end
