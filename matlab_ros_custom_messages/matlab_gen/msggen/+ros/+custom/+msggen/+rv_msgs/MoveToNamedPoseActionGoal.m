classdef MoveToNamedPoseActionGoal < ros.Message
    %MoveToNamedPoseActionGoal MATLAB implementation of rv_msgs/MoveToNamedPoseActionGoal
    ...
    properties (Constant)
        MessageType = 'rv_msgs/MoveToNamedPoseActionGoal' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '8d8e9869264fb6e754f304f5a7023944' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsMoveToNamedPoseGoalClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/MoveToNamedPoseGoal') % Dispatch to MATLAB class for message type rv_msgs/MoveToNamedPoseGoal
    ...
    methods
        function obj = MoveToNamedPoseActionGoal(msg)
            %MoveToNamedPoseActionGoal Construct the message object MoveToNamedPoseActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'MoveToNamedPoseActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'MoveToNamedPoseActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.RvMsgsMoveToNamedPoseGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.RvMsgsMoveToNamedPoseGoalClass}, {'nonempty', 'scalar'}, 'MoveToNamedPoseActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.RvMsgsMoveToNamedPoseGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.MoveToNamedPoseActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.MoveToNamedPoseActionGoal;
            obj.reload(strObj);
        end
    end
end
