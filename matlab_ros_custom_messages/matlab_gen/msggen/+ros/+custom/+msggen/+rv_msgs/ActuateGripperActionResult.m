classdef ActuateGripperActionResult < ros.Message
    %ActuateGripperActionResult MATLAB implementation of rv_msgs/ActuateGripperActionResult
    ...
    properties (Constant)
        MessageType = 'rv_msgs/ActuateGripperActionResult' % The ROS message type
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsActuateGripperResultClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/ActuateGripperResult') % Dispatch to MATLAB class for message type rv_msgs/ActuateGripperResult
    ...
    methods
        function obj = ActuateGripperActionResult(msg)
            %ActuateGripperActionResult Construct the message object ActuateGripperActionResult
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'ActuateGripperActionResult', 'Header');
        ...
        function set.Status(obj, status)
            ...
            validateattributes(status, {obj.ActionlibMsgsGoalStatusClass}, {'nonempty', 'scalar'}, 'ActuateGripperActionResult', 'Status');
        ...
        function result = get.Result(obj)
            ...
            if isempty(obj.Cache.Result)
                obj.Cache.Result = feval(obj.RvMsgsActuateGripperResultClass, obj.JavaMessage.getResult);
            end
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {obj.RvMsgsActuateGripperResultClass}, {'nonempty', 'scalar'}, 'ActuateGripperActionResult', 'Result');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Result = feval([obj.RvMsgsActuateGripperResultClass '.loadobj'], strObj.Result);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.ActuateGripperActionResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.ActuateGripperActionResult;
            obj.reload(strObj);
        end
    end
end
