classdef AskQuestionActionResult < ros.Message
    %AskQuestionActionResult MATLAB implementation of rv_msgs/AskQuestionActionResult
    ...
    properties (Constant)
        MessageType = 'rv_msgs/AskQuestionActionResult' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '0861b442332711de392d2cdb50780adb' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsAskQuestionResultClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/AskQuestionResult') % Dispatch to MATLAB class for message type rv_msgs/AskQuestionResult
    ...
    methods
        function obj = AskQuestionActionResult(msg)
            %AskQuestionActionResult Construct the message object AskQuestionActionResult
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'AskQuestionActionResult', 'Header');
        ...
        function set.Status(obj, status)
            ...
            validateattributes(status, {obj.ActionlibMsgsGoalStatusClass}, {'nonempty', 'scalar'}, 'AskQuestionActionResult', 'Status');
        ...
        function result = get.Result(obj)
            ...
            if isempty(obj.Cache.Result)
                obj.Cache.Result = feval(obj.RvMsgsAskQuestionResultClass, obj.JavaMessage.getResult);
            end
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {obj.RvMsgsAskQuestionResultClass}, {'nonempty', 'scalar'}, 'AskQuestionActionResult', 'Result');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Result = feval([obj.RvMsgsAskQuestionResultClass '.loadobj'], strObj.Result);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.AskQuestionActionResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.AskQuestionActionResult;
            obj.reload(strObj);
        end
    end
end
