classdef GraspObjectActionResult < ros.Message
    %GraspObjectActionResult MATLAB implementation of rv_msgs/GraspObjectActionResult
    ...
    properties (Constant)
        MessageType = 'rv_msgs/GraspObjectActionResult' % The ROS message type
    end
    ...
    properties (Constant, Access = protected)
        ...
        RvMsgsGraspObjectResultClass = ros.msg.internal.MessageFactory.getClassForType('rv_msgs/GraspObjectResult') % Dispatch to MATLAB class for message type rv_msgs/GraspObjectResult
    ...
    methods
        function obj = GraspObjectActionResult(msg)
            %GraspObjectActionResult Construct the message object GraspObjectActionResult
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'GraspObjectActionResult', 'Header');
        ...
        function set.Status(obj, status)
            ...
            validateattributes(status, {obj.ActionlibMsgsGoalStatusClass}, {'nonempty', 'scalar'}, 'GraspObjectActionResult', 'Status');
        ...
        function result = get.Result(obj)
            ...
            if isempty(obj.Cache.Result)
                obj.Cache.Result = feval(obj.RvMsgsGraspObjectResultClass, obj.JavaMessage.getResult);
            end
        ...
        function set.Result(obj, result)
            ...
            validateattributes(result, {obj.RvMsgsGraspObjectResultClass}, {'nonempty', 'scalar'}, 'GraspObjectActionResult', 'Result');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Result = feval([obj.RvMsgsGraspObjectResultClass '.loadobj'], strObj.Result);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.rv_msgs.GraspObjectActionResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.rv_msgs.GraspObjectActionResult;
            obj.reload(strObj);
        end
    end
end
