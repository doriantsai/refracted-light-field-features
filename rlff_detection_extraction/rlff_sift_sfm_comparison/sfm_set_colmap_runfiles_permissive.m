function sfm_set_colmap_runfiles_permissive(colmap_folder,nLF,exp_name, case_name)
...
Mapper_default_options.min_num_matches = 1;
...
Mapper_default_options.init_min_num_inliers = 30;
...
Mapper_default_options.abs_pose_min_num_inliers = 3;
Mapper_default_options.abs_pose_min_inlier_ratio = 0.1;
...
Mapper_default_options.tri_ignore_two_view_tracks = 0;
